...
import { _DisposeViewRepeaterStrategy } from './chunk-2KTTB24I.js';
import { CDK_VIRTUAL_SCROLL_VIEWPORT, ScrollingModule, ViewportRuler } from './chunk-GIE5PT4E.js';
import {
  DataSource,
  _RecycleViewRepeaterStrategy,
  _ViewRepeaterOperation,
  isDataSource,
} from './chunk-4RMX27RI.js';
import './chunk-ROUR55JA.js';
import './chunk-KQYFGZWB.js';
import { Platform, _isNumberValue } from './chunk-6LUG3UMO.js';
...
var CdkColumnDef = class _CdkColumnDef {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    contentQueries: function CdkColumnDef_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, CdkCellDef, 5)(dirIndex, CdkHeaderCellDef, 5)(
          dirIndex,
          CdkFooterCellDef,
          5,
        );
...
var CdkTable = class _CdkTable {
  ...
  ngOnInit() {
    ...
    this._viewportRuler
      .change()
      .pipe((0, import_operators.takeUntil)(this._onDestroy))
      .subscribe(() => {
        this._forceRecalculateCellWidths = true;
      });
  }
  ...
  _observeRenderChanges() {
    ...
    this._renderChangeSubscription = (0, import_rxjs.combineLatest)([dataStream, this.viewChange])
      .pipe((0, import_operators.takeUntil)(this._onDestroy))
  ...
  _setupVirtualScrolling(viewport) {
    const virtualScrollScheduler =
      typeof requestAnimationFrame !== 'undefined'
        ? import_rxjs.animationFrameScheduler
        : import_rxjs.asapScheduler;
    ...
    viewport.renderedRangeStream
      .pipe(
        (0, import_operators.auditTime)(0, virtualScrollScheduler),
        (0, import_operators.takeUntil)(this._onDestroy),
      )
    ...
    (0, import_rxjs.combineLatest)([viewport.renderedContentOffset, this._headerRowStickyUpdates])
      .pipe((0, import_operators.takeUntil)(this._onDestroy))
    ...
    (0, import_rxjs.combineLatest)([viewport.renderedContentOffset, this._footerRowStickyUpdates])
      .pipe((0, import_operators.takeUntil)(this._onDestroy))
      .subscribe(([offsetFromTop, update]) => {
        if (!update.sizes || !update.offsets || !update.elements) {
          return;
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function CdkTable_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, CdkNoDataRow, 5)(dirIndex, CdkColumnDef, 5)(
          dirIndex,
          CdkRowDef,
          5,
        )(dirIndex, CdkHeaderRowDef, 5)(dirIndex, CdkFooterRowDef, 5);
      }
      if (rf & 2) {
        let _t;
    ...
    template: function CdkTable_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(3, CdkTable_Conditional_3_Template, 7, 0)(
          4,
          CdkTable_Conditional_4_Template,
          4,
          0,
        );
      }
...
var MatTable = class _MatTable extends CdkTable {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTable_Factory(__ngFactoryType__) {
      return (ɵMatTable_BaseFactory || (ɵMatTable_BaseFactory = ɵɵgetInheritedFactory(_MatTable)))(
        __ngFactoryType__ || _MatTable,
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTable_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(3, MatTable_Conditional_3_Template, 7, 0)(
          4,
          MatTable_Conditional_4_Template,
          4,
          0,
        );
      }
...
var MatCellDef = class _MatCellDef extends CdkCellDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatCellDef_Factory(__ngFactoryType__) {
      return (
        ɵMatCellDef_BaseFactory || (ɵMatCellDef_BaseFactory = ɵɵgetInheritedFactory(_MatCellDef))
      )(__ngFactoryType__ || _MatCellDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatCellDef,
...
var MatHeaderCellDef = class _MatHeaderCellDef extends CdkHeaderCellDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderCellDef_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatHeaderCellDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatFooterCellDef = class _MatFooterCellDef extends CdkFooterCellDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterCellDef_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatFooterCellDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatColumnDef = class _MatColumnDef extends CdkColumnDef {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatColumnDef_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatColumnDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatColumnDef,
...
var MatHeaderCell = class _MatHeaderCell extends CdkHeaderCell {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderCell_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatHeaderCell);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatHeaderCell,
...
var MatFooterCell = class _MatFooterCell extends CdkFooterCell {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterCell_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatFooterCell);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatFooterCell,
...
var MatCell = class _MatCell extends CdkCell {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatCell_Factory(__ngFactoryType__) {
      return (ɵMatCell_BaseFactory || (ɵMatCell_BaseFactory = ɵɵgetInheritedFactory(_MatCell)))(
        __ngFactoryType__ || _MatCell,
      );
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatHeaderRowDef = class _MatHeaderRowDef extends CdkHeaderRowDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderRowDef_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatHeaderRowDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatFooterRowDef = class _MatFooterRowDef extends CdkFooterRowDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterRowDef_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatFooterRowDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatRowDef = class _MatRowDef extends CdkRowDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatRowDef_Factory(__ngFactoryType__) {
      return (
        ɵMatRowDef_BaseFactory || (ɵMatRowDef_BaseFactory = ɵɵgetInheritedFactory(_MatRowDef))
      )(__ngFactoryType__ || _MatRowDef);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatRowDef,
...
var MatHeaderRow = class _MatHeaderRow extends CdkHeaderRow {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderRow_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatHeaderRow);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _MatHeaderRow,
...
var MatFooterRow = class _MatFooterRow extends CdkFooterRow {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterRow_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatFooterRow);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _MatFooterRow,
...
var MatRow = class _MatRow extends CdkRow {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatRow_Factory(__ngFactoryType__) {
      return (ɵMatRow_BaseFactory || (ɵMatRow_BaseFactory = ɵɵgetInheritedFactory(_MatRow)))(
        __ngFactoryType__ || _MatRow,
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
...
var MatTextColumn = class _MatTextColumn extends CdkTextColumn {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTextColumn_Factory(__ngFactoryType__) {
      ...
      )(__ngFactoryType__ || _MatTextColumn);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _MatTextColumn,
...
var MatTableDataSource = class extends DataSource {
  ...
  _updateChangeSubscription() {
    const sortChange = this._sort
      ? (0, import_rxjs2.merge)(this._sort.sortChange, this._sort.initialized)
      : (0, import_rxjs2.of)(null);
    ...
    const filteredData = (0, import_rxjs2.combineLatest)([dataStream, this._filter]).pipe(
      (0, import_operators2.map)(([data]) => this._filterData(data)),
    );
    const orderedData = (0, import_rxjs2.combineLatest)([filteredData, sortChange]).pipe(
      (0, import_operators2.map)(([data]) => this._orderData(data)),
    );
    const paginatedData = (0, import_rxjs2.combineLatest)([orderedData, pageChange]).pipe(
      (0, import_operators2.map)(([data]) => this._pageData(data)),
    );
