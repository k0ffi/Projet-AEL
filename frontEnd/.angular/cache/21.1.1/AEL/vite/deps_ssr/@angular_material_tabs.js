...
import { SharedResizeObserver } from './chunk-KXX46RHC.js';
import { CdkPortal, CdkPortalOutlet, TemplatePortal } from './chunk-MFKECP4X.js';
import { CdkScrollable, ViewportRuler } from './chunk-GIE5PT4E.js';
import './chunk-4RMX27RI.js';
import { MAT_RIPPLE_GLOBAL_OPTIONS, MatRipple, _StructuralStylesLoader } from './chunk-DYWT6TPD.js';
import {
  CdkMonitorFocus,
  CdkObserveContent,
  ENTER,
...
function MatTabGroup_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty('id', ctx_r5._getTabLabelId(tab_r4, $index_r5))('disabled', tab_r4.disabled)(
      'fitInkBarToContent',
      ctx_r5.fitInkBarToContent,
    );
    ɵɵattribute('tabIndex', ctx_r5._getTabIndex($index_r5))('aria-posinset', $index_r5 + 1)(
      'aria-setsize',
      ctx_r5._tabs.length,
    )('aria-controls', ctx_r5._getTabContentId($index_r5))(
      'aria-selected',
      ctx_r5.selectedIndex === $index_r5,
    )('aria-label', tab_r4.ariaLabel || null)(
      'aria-labelledby',
...
function MatTabGroup_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      ...
      '_onCentering',
      function MatTabGroup_For_8_Template_mat_tab_body__onCentering_0_listener($event) {
        ɵɵrestoreView(_r9);
        const ctx_r5 = ɵɵnextContext();
      ...
      '_beforeCentering',
      function MatTabGroup_For_8_Template_mat_tab_body__beforeCentering_0_listener($event) {
        ɵɵrestoreView(_r9);
        const ctx_r5 = ɵɵnextContext();
  ...
  if (rf & 2) {
    ...
    ɵɵproperty('id', ctx_r5._getTabContentId($index_r11))('content', tab_r10.content)(
      'position',
      tab_r10.position,
    )('animationDuration', ctx_r5.animationDuration)('preserveContent', ctx_r5.preserveContent);
    ɵɵattribute(
      'tabindex',
      ctx_r5.contentTabIndex != null && ctx_r5.selectedIndex === $index_r11
        ? ctx_r5.contentTabIndex
        : null,
    )('aria-labelledby', ctx_r5._getTabLabelId(tab_r10, $index_r11))(
      'aria-hidden',
      ctx_r5.selectedIndex !== $index_r11,
    );
  }
}
...
var MatTabLabel = class _MatTabLabel extends CdkPortal {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTabLabel_Factory(__ngFactoryType__) {
      return (
        ɵMatTabLabel_BaseFactory || (ɵMatTabLabel_BaseFactory = ɵɵgetInheritedFactory(_MatTabLabel))
      )(__ngFactoryType__ || _MatTabLabel);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatTabLabel,
...
var MatTabLabelWrapper = class _MatTabLabelWrapper extends InkBarItem {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTabLabelWrapper_Factory(__ngFactoryType__) {
      return (
        ɵMatTabLabelWrapper_BaseFactory ||
        (ɵMatTabLabelWrapper_BaseFactory = ɵɵgetInheritedFactory(_MatTabLabelWrapper))
      )(__ngFactoryType__ || _MatTabLabelWrapper);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  ...
  ngAfterContentInit() {
    ...
    const resize = this._sharedResizeObserver
      ...
      .pipe(
        (0, import_operators.debounceTime)(32),
  ...
  _itemsResized() {
    ...
    return this._items.changes.pipe(
      ...
      (0, import_operators.filter)((entries) =>
  ...
  _handlePaginatorPress(direction, mouseEvent) {
    ...
    this._stopInterval();
    (0, import_rxjs.timer)(HEADER_SCROLL_DELAY, HEADER_SCROLL_INTERVAL)
      .pipe(
        (0, import_operators.takeUntil)(
          (0, import_rxjs.merge)(this._stopScrolling, this._destroyed),
        ),
      )
      .subscribe(() => {
...
var MatTabHeader = class _MatTabHeader extends MatPaginatedTabHeader {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTabHeader_Factory(__ngFactoryType__) {
      return (
        ɵMatTabHeader_BaseFactory ||
        (ɵMatTabHeader_BaseFactory = ɵɵgetInheritedFactory(_MatTabHeader))
      )(__ngFactoryType__ || _MatTabHeader);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _MatTabHeader,
    ...
    hostBindings: function MatTabHeader_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('mat-mdc-tab-header-pagination-controls-enabled', ctx._showPaginationControls)(
          'mat-mdc-tab-header-rtl',
          ctx._getLayoutDirection() == 'rtl',
        );
      }
    },
    inputs: {
...
var MatTabBodyPortal = class _MatTabBodyPortal extends CdkPortalOutlet {
  ...
  ngOnInit() {
    ...
    this._centeringSub = this._host._beforeCentering
      .pipe((0, import_operators.startWith)(this._host._isCenterPosition()))
...
var MatTabBody = class _MatTabBody {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTabBody_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵclassProp('mat-tab-body-content-left', ctx._position === 'left')(
          'mat-tab-body-content-right',
          ctx._position === 'right',
        )(
          'mat-tab-body-content-can-animate',
          ctx._position === 'center' || ctx._previousPosition === 'center',
        );
      }
    },
...
var MatTabGroup = class _MatTabGroup {
  ...
  _subscribeToTabLabels() {
    ...
    this._tabLabelSubscription = (0, import_rxjs.merge)(
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTabGroup_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener(
          'indexFocused',
          function MatTabGroup_Template_mat_tab_header_indexFocused_0_listener($event) {
            ɵɵrestoreView(_r1);
            return ɵɵresetView(ctx._focusChanged($event));
          },
        )(
          'selectFocusedIndex',
          function MatTabGroup_Template_mat_tab_header_selectFocusedIndex_0_listener($event) {
            ɵɵrestoreView(_r1);
      ...
      if (rf & 2) {
        ɵɵproperty('selectedIndex', ctx.selectedIndex || 0)('disableRipple', ctx.disableRipple)(
          'disablePagination',
...
var MatTabNav = class _MatTabNav extends MatPaginatedTabHeader {
  ...
  ngAfterContentInit() {
    this._inkBar = new MatInkBar(this._items);
    this._items.changes
      .pipe((0, import_operators.startWith)(null), (0, import_operators.takeUntil)(this._destroyed))
    ...
    hostBindings: function MatTabNav_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-mdc-tab-header-pagination-controls-enabled', ctx._showPaginationControls)(
          'mat-mdc-tab-header-rtl',
          ctx._getLayoutDirection() == 'rtl',
        )('mat-mdc-tab-nav-bar-stretch-tabs', ctx.stretchTabs)(
          'mat-primary',
          ctx.color !== 'warn' && ctx.color !== 'accent',
...
var MatTabLink = class _MatTabLink extends InkBarItem {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatTabLink_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute('aria-controls', ctx._getAriaControls())('aria-current', ctx._getAriaCurrent())(
          'aria-disabled',
          ctx.disabled,
        )('aria-selected', ctx._getAriaSelected())('id', ctx.id)('tabIndex', ctx._tabIndex())(
          'role',
          ctx._getRole(),
        );
