...
import { MatIcon, MatIconModule } from './chunk-MEYGKICB.js';
import { ErrorStateMatcher } from './chunk-JMLWZ367.js';
import { ControlContainer } from './chunk-DV26X6UN.js';
import { CdkPortalOutlet, PortalModule, TemplatePortal } from './chunk-MFKECP4X.js';
import { MatRippleModule } from './chunk-UVXHUT3K.js';
import { MatRipple, _StructuralStylesLoader } from './chunk-DYWT6TPD.js';
import {
  ENTER,
  FocusKeyManager,
  FocusMonitor,
...
import { Platform } from './chunk-6LUG3UMO.js';
import { NgTemplateOutlet } from './chunk-7EE3RTIJ.js';
...
var CdkStepper = class _CdkStepper {
  ...
  ngAfterContentInit() {
    this._steps.changes
      .pipe(
        (0, import_operators.startWith)(this._steps),
  ...
  ngAfterViewInit() {
    this._stepHeader.changes
      .pipe(
        (0, import_operators.startWith)(this._stepHeader),
        (0, import_operators.takeUntil)(this._destroyed),
      )
      .subscribe((headers) => {
    ...
    (this._dir ? this._dir.change : (0, import_rxjs.of)())
      .pipe(
        (0, import_operators.startWith)(this._layoutDirection()),
        (0, import_operators.takeUntil)(this._destroyed),
      )
...
function MatStepHeader_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty('ngTemplateOutlet', ctx_r0.iconOverrides[ctx_r0.state])(
      ...
      ɵɵpureFunction3(2, _c02, ctx_r0.index, ctx_r0.active, ctx_r0.optional),
    );
  }
}
...
function MatStepHeader_Conditional_4_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵconditionalCreate(
      ...
      'span',
      8,
    )(1, MatStepHeader_Conditional_4_Case_1_Conditional_1_Template, 2, 1, 'span', 8);
...
function MatStepper_Case_1_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty('ngTemplateOutlet', horizontalStepsTemplate_r2)(
      'ngTemplateOutletContext',
      ɵɵpureFunction1(3, _c3, ctx_r0.steps),
    );
  }
}
function MatStepper_Case_1_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty('ngTemplateOutlet', horizontalStepsTemplate_r2)(
      'ngTemplateOutletContext',
      ɵɵpureFunction1(2, _c3, ctx_r0.steps),
    );
  }
}
function MatStepper_Case_1_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute('aria-labelledby', ctx_r0._getStepLabelId($index_r4))(
      'inert',
      ctx_r0.selectedIndex === $index_r4 ? null : '',
    );
    ɵɵadvance(2);
...
function MatStepper_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(1, MatStepper_Case_1_Conditional_1_Template, 3, 5, 'div', 5)(
      2,
      MatStepper_Case_1_Conditional_2_Template,
      1,
      4,
      'ng-container',
      6,
    ...
    ɵɵrepeaterCreate(
      4,
      MatStepper_Case_1_For_5_Template,
      3,
      6,
      'div',
      8,
...
function MatStepper_Case_2_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty('ngTemplateOutlet', stepTemplate_r9)(
      'ngTemplateOutletContext',
      ɵɵpureFunction1(10, _c4, step_r5),
    );
    ɵɵadvance();
    ɵɵclassProp('mat-stepper-vertical-line', !(ɵ$index_29_r7 === ɵ$count_29_r8 - 1))(
      'mat-vertical-content-container-active',
      ctx_r0.selectedIndex === $index_r6,
    );
...
function MatStepper_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(
      2,
      MatStepper_Case_2_For_3_Template,
      7,
      12,
      'div',
      11,
...
function MatStepper_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      ...
      'keydown',
      function MatStepper_ng_template_3_Template_mat_step_header_keydown_0_listener($event) {
        ɵɵrestoreView(_r10);
        const ctx_r0 = ɵɵnextContext();
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵclassProp('mat-horizontal-stepper-header', ctx_r0.orientation === 'horizontal')(
      'mat-vertical-stepper-header',
      ctx_r0.orientation === 'vertical',
    );
    ɵɵproperty('tabIndex', ctx_r0._getFocusIndex() === step_r11.index() ? 0 : -1)(
      'id',
      ctx_r0._getStepLabelId(step_r11.index()),
    )('index', step_r11.index())('state', step_r11.indicatorType())(
      'label',
      step_r11.stepLabel || step_r11.label,
    )('selected', step_r11.isSelected())('active', step_r11.isNavigable())(
      'optional',
      step_r11.optional,
    )('errorMessage', step_r11.errorMessage)('iconOverrides', ctx_r0._iconOverrides)(
      'disableRipple',
      ctx_r0.disableRipple || !step_r11.isNavigable(),
    )('color', step_r11.color || ctx_r0.color);
    ɵɵattribute('role', ctx_r0.orientation === 'horizontal' ? 'tab' : 'button')(
      'aria-posinset',
      ctx_r0.orientation === 'horizontal' ? step_r11.index() + 1 : null,
    )('aria-setsize', ctx_r0.orientation === 'horizontal' ? ctx_r0.steps.length : null)(
      'aria-selected',
      ctx_r0.orientation === 'horizontal' ? step_r11.isSelected() : null,
    )('aria-current', ctx_r0.orientation === 'vertical' && step_r11.isSelected() ? 'step' : null)(
      'aria-disabled',
      ctx_r0.orientation === 'vertical' && step_r11.isSelected() ? 'true' : null,
    )('aria-expanded', ctx_r0.orientation === 'vertical' ? step_r11.isSelected() : null)(
      'aria-controls',
      ctx_r0._getStepContentId(step_r11.index()),
    )('aria-label', step_r11.ariaLabel || null)(
      'aria-labelledby',
      !step_r11.ariaLabel && step_r11.ariaLabelledby ? step_r11.ariaLabelledby : null,
    )('aria-disabled', step_r11.isNavigable() ? null : true);
  }
}
...
function MatStepper_ng_template_5_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty('ngTemplateOutlet', stepTemplate_r9)(
      'ngTemplateOutletContext',
      ɵɵpureFunction1(3, _c4, step_r12),
    );
    ɵɵadvance();
...
function MatStepper_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(
      1,
      MatStepper_ng_template_5_For_2_Template,
      2,
      5,
      null,
      null,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatStepHeader_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(6, MatStepHeader_Conditional_6_Template, 2, 1, 'div', 4)(
          7,
      ...
      .pipe(
        (0, import_operators2.switchMap)(() => {
          return this._stepper.selectionChange.pipe(
            (0, import_operators2.map)((event) => event.selectedStep === this),
            (0, import_operators2.startWith)(this._stepper.selected === this),
          );
        }),
      )
...
var MatStepper = class _MatStepper extends CdkStepper {
  ...
  ngAfterContentInit() {
    ...
    this.steps.changes
      .pipe((0, import_operators2.takeUntil)(this._destroyed))
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: [
      ['stepTemplate', ''],
      ['horizontalStepsTemplate', ''],
      ['animatedContainer', ''],
      [1, 'mat-horizontal-stepper-wrapper'],
      [1, 'mat-vertical-stepper-wrapper'],
      [1, 'mat-horizontal-stepper-header-wrapper'],
      [3, 'ngTemplateOutlet', 'ngTemplateOutletContext'],
      ...
      ['role', 'region', 1, 'mat-vertical-stepper-content', 3, 'id'],
    ...
    template: function MatStepper_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(1, MatStepper_Case_1_Template, 6, 1, 'div', 3)(
          2,
        ...
        ɵɵtemplate(
          ...
          5,
          MatStepper_ng_template_5_Template,
          3,
          0,
          'ng-template',
          null,
