...
import { trustedHTMLFromString } from './chunk-EOGLXG4P.js';
import { DomSanitizer } from './chunk-JVHL6J2G.js';
import { HttpClient } from './chunk-UIARJYOI.js';
...
var MatIconRegistry = class _MatIconRegistry {
  ...
  getSvgIconFromUrl(safeUrl) {
    ...
    return this._loadSvgIconFromConfig(new SvgIconConfig(safeUrl, null)).pipe(
      (0, import_operators.tap)((svg) => this._cachedIconsByUrl.set(url, svg)),
      (0, import_operators.map)((svg) => cloneSvg(svg)),
    );
  }
  ...
  _getSvgFromIconSetConfigs(name, iconSetConfigs) {
    ...
    return (0, import_rxjs.forkJoin)(iconSetFetchRequests).pipe(
  ...
  _loadSvgIconFromConfig(config) {
    return this._fetchIcon(config).pipe(
      (0, import_operators.tap)((svgText) => (config.svgText = svgText)),
      (0, import_operators.map)(() => this._svgElementFromConfig(config)),
    );
  }
  ...
  _fetchIcon(iconConfig) {
    ...
    const req = this._httpClient
      ...
      .pipe(
        (0, import_operators.map)((svg) => {
          return trustedHTMLFromString(svg);
        }),
        (0, import_operators.finalize)(() => this._inProgressUrlFetches.delete(url)),
  ...
  _updateSvgIcon(rawName) {
    ...
    if (rawName) {
      ...
      this._currentIconFetch = this._iconRegistry
        ...
        .pipe((0, import_operators2.take)(1))
        .subscribe(
...
//# sourceMappingURL=chunk-MEYGKICB.js.map
