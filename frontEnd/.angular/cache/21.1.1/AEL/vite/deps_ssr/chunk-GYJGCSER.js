...
import { DomPortalOutlet, PortalModule, TemplatePortal } from './chunk-MFKECP4X.js';
import { ScrollDispatcher, ScrollingModule, ViewportRuler } from './chunk-GIE5PT4E.js';
import {
  ESCAPE,
  _IdGenerator,
  _getEventTarget,
...
import { coerceArray, coerceCssPixelValue } from './chunk-ROUR55JA.js';
import { _CdkPrivateStyleLoader } from './chunk-A6YSO6S5.js';
import { supportsScrollBehavior } from './chunk-KQYFGZWB.js';
import { Platform } from './chunk-6LUG3UMO.js';
import { Location } from './chunk-7EE3RTIJ.js';
...
var CloseScrollStrategy = class {
  ...
  enable() {
    ...
    const stream = this._scrollDispatcher.scrolled(0).pipe(
      (0, import_operators.filter)((scrollable) => {
        return (
          !scrollable ||
...
var CDK_CONNECTED_OVERLAY_DEFAULT_CONFIG = new InjectionToken(
  ...
  attachOverlay() {
    ...
    if (this.positionChange.observers.length > 0) {
      this._positionSubscription = this._position.positionChanges
        .pipe((0, import_operators.takeWhile)(() => this.positionChange.observers.length > 0))
        .subscribe((position) => {
...
//# sourceMappingURL=chunk-GYJGCSER.js.map
