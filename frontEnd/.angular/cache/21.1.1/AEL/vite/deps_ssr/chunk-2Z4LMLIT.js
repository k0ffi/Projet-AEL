...
import { _VisuallyHiddenLoader, _setInnerHtml } from './chunk-EOGLXG4P.js';
import { DomSanitizer } from './chunk-JVHL6J2G.js';
import { coerceArray } from './chunk-ROUR55JA.js';
...
var Typeahead = class {
  ...
  _setupKeyHandler(typeAheadInterval) {
    this._letterKeyStream
      .pipe(
        (0, import_operators4.tap)((letter) => this._pressedLetters.push(letter)),
        (0, import_operators4.debounceTime)(typeAheadInterval),
        (0, import_operators4.filter)(() => this._pressedLetters.length > 0),
        (0, import_operators4.map)(() => this._pressedLetters.join('').toLocaleUpperCase()),
      )
  ...
  _expandCurrentItem() {
    ...
    if (!this._isCurrentItemExpanded()) {
      ...
      coerceObservable(this._activeItem.getChildren())
        .pipe((0, import_operators5.take)(1))
        .subscribe((children) => {
...
//# sourceMappingURL=chunk-2Z4LMLIT.js.map
