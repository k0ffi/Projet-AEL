...
var MatDrawer = class _MatDrawer {
  ...
  _openedStream = this.openedChange.pipe(
    (0, import_operators.filter)((o) => o),
    (0, import_operators.map)(() => {}),
  );
  openedStart = this._animationStarted.pipe(
    (0, import_operators.filter)(() => this.opened),
    (0, import_operators.mapTo)(void 0),
  );
  ...
  _setOpen(isOpen, restoreFocus, focusOrigin) {
    ...
    return new Promise((resolve) => {
      this.openedChange
        .pipe((0, import_operators.take)(1))
    ...
    hostBindings: function MatDrawer_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-drawer-end', ctx.position === 'end')(
          'mat-drawer-over',
          ctx.mode === 'over',
        )('mat-drawer-push', ctx.mode === 'push')('mat-drawer-side', ctx.mode === 'side');
      }
    },
    inputs: {
      position: 'position',
...
var MatDrawerContainer = class _MatDrawerContainer {
  ...
  ngAfterContentInit() {
    this._allDrawers.changes
      .pipe(
        (0, import_operators.startWith)(this._allDrawers),
  ...
  _watchDrawerToggle(drawer) {
    drawer._animationStarted
      .pipe((0, import_operators.takeUntil)(this._drawers.changes))
      .subscribe(() => {
        this.updateContentMargins();
        this._changeDetectorRef.markForCheck();
      });
    ...
    drawer._modeChanged
      .pipe(
        (0, import_operators.takeUntil)(
          (0, import_rxjs.merge)(this._drawers.changes, this._destroyed),
        ),
      )
      .subscribe(() => {
        this.updateContentMargins();
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatSidenavContent_Factory(__ngFactoryType__) {
      return (
        ...
        (ɵMatSidenavContent_BaseFactory = ɵɵgetInheritedFactory(_MatSidenavContent))
      )(__ngFactoryType__ || _MatSidenavContent);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
...
var MatSidenav = class _MatSidenav extends MatDrawer {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatSidenav_Factory(__ngFactoryType__) {
      return (
        ɵMatSidenav_BaseFactory || (ɵMatSidenav_BaseFactory = ɵɵgetInheritedFactory(_MatSidenav))
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatSidenavContainer_Factory(__ngFactoryType__) {
      return (
        ...
        (ɵMatSidenavContainer_BaseFactory = ɵɵgetInheritedFactory(_MatSidenavContainer))
