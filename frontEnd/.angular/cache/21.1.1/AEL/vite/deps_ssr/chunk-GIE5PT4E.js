...
import { ArrayDataSource, _RecycleViewRepeaterStrategy, isDataSource } from './chunk-4RMX27RI.js';
import {
  RtlScrollAxisType,
  getRtlScrollAxisType,
  supportsScrollBehavior,
} from './chunk-KQYFGZWB.js';
import { Platform, coerceElement, coerceNumberProperty } from './chunk-6LUG3UMO.js';
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  scrolled(auditTimeInMs = DEFAULT_SCROLL_TIME) {
    ...
    return new import_rxjs.Observable((observer) => {
      ...
      const subscription =
        auditTimeInMs > 0
          ? this._scrolled.pipe((0, import_operators.auditTime)(auditTimeInMs)).subscribe(observer)
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe(
      (0, import_operators.filter)((target) => !target || ancestors.indexOf(target) > -1),
    );
  }
...
var ViewportRuler = class _ViewportRuler {
  ...
  change(throttleTime = DEFAULT_RESIZE_TIME) {
    return throttleTime > 0
      ? this._change.pipe((0, import_operators.auditTime)(throttleTime))
      : this._change;
  }
  _getWindow() {
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  appendOnly = false;
  scrolledIndexChange = new import_rxjs.Observable((observer) =>
  ...
  renderedContentOffset = this._renderedContentOffsetSubject.pipe(
    (0, import_operators.filter)((offset) => offset !== null),
    (0, import_operators.distinctUntilChanged)(),
  );
  _totalContentSize = 0;
  ...
  attach(forOf) {
    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      this._forOf.dataStream
        .pipe((0, import_operators.takeUntil)(this._detachedSubject))
        .subscribe((data) => {
  ...
  set cdkVirtualForOf(value) {
    ...
    if (isDataSource(value)) {
      ...
      this._dataSourceChanges.next(
        new ArrayDataSource((0, import_rxjs.isObservable)(value) ? value : Array.from(value || [])),
      );
    }
  }
  _cdkVirtualForOf;
...
//# sourceMappingURL=chunk-GIE5PT4E.js.map
