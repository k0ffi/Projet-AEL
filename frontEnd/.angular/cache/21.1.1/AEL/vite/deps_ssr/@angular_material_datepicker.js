...
import { DateAdapter, MAT_DATE_FORMATS } from './chunk-HHA5OTLT.js';
import { MAT_INPUT_VALUE_ACCESSOR } from './chunk-EAKPLUYC.js';
import { _ErrorStateTracker } from './chunk-N3BMKQPL.js';
import { ErrorStateMatcher } from './chunk-JMLWZ367.js';
import { MAT_FORM_FIELD, MatFormFieldControl } from './chunk-57LTD7NS.js';
import './chunk-KXX46RHC.js';
import {
  ControlContainer,
  FormGroupDirective,
  NG_VALIDATORS,
...
} from './chunk-GYJGCSER.js';
import {
  CdkPortalOutlet,
  ComponentPortal,
  PortalModule,
  TemplatePortal,
} from './chunk-MFKECP4X.js';
import { CdkScrollableModule, ScrollDispatcher } from './chunk-GIE5PT4E.js';
import './chunk-4RMX27RI.js';
import { MatButton, MatButtonModule, MatIconButton } from './chunk-L4ZDYTBW.js';
import './chunk-3YSJ6KLW.js';
import './chunk-UVXHUT3K.js';
import { _StructuralStylesLoader } from './chunk-DYWT6TPD.js';
import {
  A11yModule,
  AriaDescriber,
  BACKSPACE,
  ...
  hasModifierKey,
} from './chunk-2Z4LMLIT.js';
import { _VisuallyHiddenLoader } from './chunk-EOGLXG4P.js';
import './chunk-JVHL6J2G.js';
import './chunk-U35V577Y.js';
import { coerceBooleanProperty, coerceStringArray } from './chunk-ROUR55JA.js';
import { _CdkPrivateStyleLoader } from './chunk-A6YSO6S5.js';
import './chunk-KQYFGZWB.js';
import { Platform, coerceNumberProperty } from './chunk-6LUG3UMO.js';
import { NgClass } from './chunk-7EE3RTIJ.js';
import './chunk-UIARJYOI.js';
import './chunk-X2FHHFPE.js';
import { BidiModule, Directionality } from './chunk-WHITI2DF.js';
import {
...
var MatTooltip = class _MatTooltip {
  ...
  ngAfterViewInit() {
    ...
    this._focusMonitor
      ...
      .pipe((0, import_operators.takeUntil)(this._destroyed))
      .subscribe((origin) => {
        if (!origin) {
...
var TooltipComponent = class _TooltipComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: [
      ['tooltip', ''],
      [1, 'mdc-tooltip', 'mat-mdc-tooltip', 3, 'animationend'],
...
function MatCalendarBody_For_2_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵtextInterpolate1(
      ' ',
      ctx_r0._firstRowOffset >= ctx_r0.labelMinRequiredCells ? ctx_r0.label : '',
      ' ',
    );
  }
}
function MatCalendarBody_For_2_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      'click',
      function MatCalendarBody_For_2_For_3_Template_button_click_1_listener($event) {
  ...
  if (rf & 2) {
    ...
    )('mat-calendar-body-range-start', ctx_r0._isRangeStart(item_r3.compareValue))(
      'mat-calendar-body-range-end',
      ctx_r0._isRangeEnd(item_r3.compareValue),
    )('mat-calendar-body-in-range', ctx_r0._isInRange(item_r3.compareValue))(
      'mat-calendar-body-comparison-bridge-start',
      ctx_r0._isComparisonBridgeStart(item_r3.compareValue, ɵ$index_7_r5, ɵ$index_14_r4),
    )(
      'mat-calendar-body-comparison-bridge-end',
      ctx_r0._isComparisonBridgeEnd(item_r3.compareValue, ɵ$index_7_r5, ɵ$index_14_r4),
    )('mat-calendar-body-comparison-start', ctx_r0._isComparisonStart(item_r3.compareValue))(
      'mat-calendar-body-comparison-end',
      ctx_r0._isComparisonEnd(item_r3.compareValue),
    )('mat-calendar-body-in-comparison-range', ctx_r0._isInComparisonRange(item_r3.compareValue))(
      'mat-calendar-body-preview-start',
      ctx_r0._isPreviewStart(item_r3.compareValue),
    )('mat-calendar-body-preview-end', ctx_r0._isPreviewEnd(item_r3.compareValue))(
    ...
    ɵɵattribute('aria-label', item_r3.ariaLabel)('aria-disabled', !item_r3.enabled || null)(
      'aria-pressed',
      ctx_r0._isSelected(item_r3.compareValue),
    )('aria-current', ctx_r0.todayValue === item_r3.compareValue ? 'date' : null)(
      'aria-describedby',
      ctx_r0._getDescribedby(item_r3.compareValue),
    );
    ɵɵadvance();
    ɵɵclassProp('mat-calendar-body-selected', ctx_r0._isSelected(item_r3.compareValue))(
...
function MatCalendar_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener(
      'activeDateChange',
      function MatCalendar_Case_2_Template_mat_month_view_activeDateChange_0_listener($event) {
        ɵɵrestoreView(_r1);
    ...
    ɵɵlistener(
      '_userSelection',
      function MatCalendar_Case_2_Template_mat_month_view__userSelection_0_listener($event) {
        ɵɵrestoreView(_r1);
        const ctx_r1 = ɵɵnextContext();
      ...
      'dragStarted',
      function MatCalendar_Case_2_Template_mat_month_view_dragStarted_0_listener($event) {
        ɵɵrestoreView(_r1);
        const ctx_r1 = ɵɵnextContext();
      ...
      'dragEnded',
      function MatCalendar_Case_2_Template_mat_month_view_dragEnded_0_listener($event) {
        ɵɵrestoreView(_r1);
        const ctx_r1 = ɵɵnextContext();
  ...
  if (rf & 2) {
    ...
    )('endDateAccessibleName', ctx_r1.endDateAccessibleName)('activeDrag', ctx_r1._activeDrag);
  }
}
function MatCalendar_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener(
      'activeDateChange',
      function MatCalendar_Case_3_Template_mat_year_view_activeDateChange_0_listener($event) {
        ɵɵrestoreView(_r3);
        const ctx_r1 = ɵɵnextContext();
        ɵɵtwoWayBindingSet(ctx_r1.activeDate, $event) || (ctx_r1.activeDate = $event);
        return ɵɵresetView($event);
    ...
    ɵɵlistener(
      'monthSelected',
      function MatCalendar_Case_3_Template_mat_year_view_monthSelected_0_listener($event) {
        ɵɵrestoreView(_r3);
        const ctx_r1 = ɵɵnextContext();
      ...
      'selectedChange',
      function MatCalendar_Case_3_Template_mat_year_view_selectedChange_0_listener($event) {
        ɵɵrestoreView(_r3);
        const ctx_r1 = ɵɵnextContext();
...
function MatCalendar_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtwoWayListener(
      'activeDateChange',
      function MatCalendar_Case_4_Template_mat_multi_year_view_activeDateChange_0_listener($event) {
        ɵɵrestoreView(_r4);
        const ctx_r1 = ɵɵnextContext();
        ɵɵtwoWayBindingSet(ctx_r1.activeDate, $event) || (ctx_r1.activeDate = $event);
        return ɵɵresetView($event);
    ...
    ɵɵlistener(
      'yearSelected',
      function MatCalendar_Case_4_Template_mat_multi_year_view_yearSelected_0_listener($event) {
        ɵɵrestoreView(_r4);
        const ctx_r1 = ɵɵnextContext();
      ...
      'selectedChange',
      function MatCalendar_Case_4_Template_mat_multi_year_view_selectedChange_0_listener($event) {
        ɵɵrestoreView(_r4);
        const ctx_r1 = ɵɵnextContext();
...
var MatCalendarBody = class _MatCalendarBody {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: [
      ...
      ['type', 'button', 1, 'mat-calendar-body-cell', 3, 'click', 'focus', 'ngClass', 'tabindex'],
    ...
    template: function MatCalendarBody_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵtextInterpolate2(
          ' ',
          ctx.comparisonDateAccessibleName,
          ' ',
...
var MatMonthView = class _MatMonthView {
  ...
  ngAfterContentInit() {
    this._rerenderSubscription = this._dateAdapter.localeChanges
      .pipe((0, import_operators2.startWith)(null))
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatMonthView_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener(
          'selectedValueChange',
          function MatMonthView_Template_tbody_selectedValueChange_7_listener($event) {
            return ctx._dateSelected($event);
          },
        )(
          'activeDateChange',
          function MatMonthView_Template_tbody_activeDateChange_7_listener($event) {
      ...
      if (rf & 2) {
        ...
        )('comparisonEnd', ctx._comparisonRangeEnd())('previewStart', ctx._previewStart())(
          'previewEnd',
          ctx._previewEnd(),
        )('isRange', ctx._isRange())('labelMinRequiredCells', 3)(
          'activeCell',
          ctx._dateAdapter.getDate(ctx.activeDate) - 1,
        )('startDateAccessibleName', ctx.startDateAccessibleName)(
          'endDateAccessibleName',
          ctx.endDateAccessibleName,
        );
      }
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatMultiYearView_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener(
          'selectedValueChange',
          function MatMultiYearView_Template_tbody_selectedValueChange_4_listener($event) {
            return ctx._yearSelected($event);
          },
        )(
          'activeDateChange',
          function MatMultiYearView_Template_tbody_activeDateChange_4_listener($event) {
            return ctx._updateActiveDate($event);
          },
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatYearView_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener(
          'selectedValueChange',
          function MatYearView_Template_tbody_selectedValueChange_4_listener($event) {
            return ctx._monthSelected($event);
          },
        )(
          'activeDateChange',
          function MatYearView_Template_tbody_activeDateChange_4_listener($event) {
            return ctx._updateActiveDate($event);
          },
...
var MatCalendarHeader = class _MatCalendarHeader {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: [
      ...
      ['matButton', '', 'type', 'button', 1, 'mat-calendar-period-button', 3, 'click'],
      ['aria-hidden', 'true'],
      ['viewBox', '0 0 10 5', 'focusable', 'false', 'aria-hidden', 'true', 1, 'mat-calendar-arrow'],
      ['points', '0,0 5,5 10,0'],
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatCalendar_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(2, MatCalendar_Case_2_Template, 1, 11, 'mat-month-view', 2)(
          3,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatDatepickerContent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener(
          'yearSelected',
          function MatDatepickerContent_Template_mat_calendar_yearSelected_1_listener($event) {
            return ctx.datepicker._selectYear($event);
          },
        )(
          'monthSelected',
          function MatDatepickerContent_Template_mat_calendar_monthSelected_1_listener($event) {
            return ctx.datepicker._selectMonth($event);
          },
        )(
          'viewChanged',
          function MatDatepickerContent_Template_mat_calendar_viewChanged_1_listener($event) {
            return ctx.datepicker._viewChanged($event);
          },
        )(
          '_userSelection',
          function MatDatepickerContent_Template_mat_calendar__userSelection_1_listener($event) {
            return ctx._handleUserSelection($event);
          },
        )(
          '_userDragDrop',
          function MatDatepickerContent_Template_mat_calendar__userDragDrop_1_listener($event) {
      ...
      if (rf & 2) {
        ...
        )('minDate', ctx.datepicker._getMinDate())('maxDate', ctx.datepicker._getMaxDate())(
          'dateFilter',
          ctx.datepicker._getDateFilter(),
        )('headerComponent', ctx.datepicker.calendarHeaderComponent)(
          'selected',
          ctx._getSelected(),
        )('dateClass', ctx.datepicker.dateClass)('comparisonStart', ctx.comparisonStart)(
          'comparisonEnd',
          ctx.comparisonEnd,
        )('startDateAccessibleName', ctx.startDateAccessibleName)(
          'endDateAccessibleName',
  ...
  _getCloseStream(overlayRef) {
    ...
    return (0, import_rxjs2.merge)(
      ...
      overlayRef.keydownEvents().pipe(
        (0, import_operators2.filter)((event) => {
          return (
...
var MatDatepickerToggle = class _MatDatepickerToggle {
  ...
  _watchStateChanges() {
    ...
    const datepickerToggled = this.datepicker
      ? (0, import_rxjs2.merge)(this.datepicker.openedStream, this.datepicker.closedStream)
      : (0, import_rxjs2.of)();
    this._stateChanges.unsubscribe();
    this._stateChanges = (0, import_rxjs2.merge)(
      this._intl.changes,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatDatepickerToggle_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-datepicker-toggle-active', ctx.datepicker && ctx.datepicker.opened)(
          'mat-accent',
          ctx.datepicker && ctx.datepicker.color === 'accent',
        )('mat-warn', ctx.datepicker && ctx.datepicker.color === 'warn');
      }
    },
    inputs: {
    ...
    consts: [
      ['button', ''],
      ['matIconButton', '', 'type', 'button', 3, 'tabIndex', 'disabled', 'disableRipple'],
      [
        'viewBox',
        '0 0 24 24',
        'width',
    ...
    template: function MatDatepickerToggle_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        )('aria-expanded', ctx.datepicker ? ctx.datepicker.opened : null);
        ɵɵadvance(2);
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatDateRangeInput_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-date-range-input-hide-placeholders', ctx._shouldHidePlaceholders())(
          'mat-date-range-input-required',
          ctx.required,
        );
      }
    },
    ...
    vars: 5,
    consts: [
      ['cdkMonitorSubtreeFocus', '', 1, 'mat-date-range-input-container', 3, 'cdkFocusChange'],
    ...
    template: function MatDateRangeInput_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener(
          'cdkFocusChange',
          function MatDateRangeInput_Template_div_cdkFocusChange_0_listener($event) {
...
var MatStartDate = class _MatStartDate extends MatDateRangeInputPartBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatStartDate_Factory(__ngFactoryType__) {
      return (
        ɵMatStartDate_BaseFactory ||
        (ɵMatStartDate_BaseFactory = ɵɵgetInheritedFactory(_MatStartDate))
      )(__ngFactoryType__ || _MatStartDate);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatStartDate,
    ...
    hostBindings: function MatStartDate_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵdomProperty('disabled', ctx.disabled);
        ɵɵattribute('aria-haspopup', ctx._rangeInput.rangePicker ? 'dialog' : null)(
          'aria-owns',
          ctx._rangeInput._ariaOwns() || null,
        )('min', ctx._getMinDate() ? ctx._dateAdapter.toIso8601(ctx._getMinDate()) : null)(
          'max',
...
var MatEndDate = class _MatEndDate extends MatDateRangeInputPartBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatEndDate_Factory(__ngFactoryType__) {
      return (
        ɵMatEndDate_BaseFactory || (ɵMatEndDate_BaseFactory = ɵɵgetInheritedFactory(_MatEndDate))
      )(__ngFactoryType__ || _MatEndDate);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
    type: _MatEndDate,
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatDateRangePicker_Factory(__ngFactoryType__) {
      return (
        ...
        (ɵMatDateRangePicker_BaseFactory = ɵɵgetInheritedFactory(_MatDateRangePicker))
