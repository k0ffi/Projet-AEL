...
function isDataSource(value) {
  return (
    ...
    !(value instanceof import_rxjs.ConnectableObservable)
  );
}
...
var ArrayDataSource = class extends DataSource {
  ...
  connect() {
    return (0, import_rxjs2.isObservable)(this._data)
      ? this._data
      : (0, import_rxjs2.of)(this._data);
  }
  disconnect() {}
};
...
//# sourceMappingURL=chunk-4RMX27RI.js.map
