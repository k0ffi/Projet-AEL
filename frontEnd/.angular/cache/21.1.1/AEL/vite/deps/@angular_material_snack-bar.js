...
import { MatButton, MatButtonModule } from './chunk-CNXOJ2HY.js';
import './chunk-XWBYLVLI.js';
import './chunk-6ZBOXUC5.js';
import './chunk-NVWZBIU7.js';
import './chunk-OUA6WZWK.js';
import './chunk-IOXJ3VXD.js';
import {
  BreakpointObserver,
  Breakpoints,
  LiveAnnouncer,
...
import { Subject, __spreadValues, of, takeUntil } from './chunk-U7EDC2PH.js';
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatSnackBarContainer_HostBindings(rf, ctx) {
      if (rf & 1) {
        ɵɵlistener(
          'animationend',
          function MatSnackBarContainer_animationend_HostBindingHandler($event) {
            return ctx.onAnimationEnd($event.animationName);
          },
        )(
          'animationcancel',
          function MatSnackBarContainer_animationcancel_HostBindingHandler($event) {
            return ctx.onAnimationEnd($event.animationName);
          },
        );
      }
      if (rf & 2) {
        ɵɵclassProp('mat-snack-bar-container-enter', ctx._animationState === 'visible')(
          'mat-snack-bar-container-exit',
          ctx._animationState === 'hidden',
        )('mat-snack-bar-container-animations-enabled', !ctx._animationsDisabled);
      }
    },
...
var MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    const config = __spreadValues(
      __spreadValues(__spreadValues({}, new MatSnackBarConfig()), this._defaultConfig),
      userConfig,
    );
