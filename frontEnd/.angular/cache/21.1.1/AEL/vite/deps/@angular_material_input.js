...
import { MatFormFieldModule } from './chunk-DVDUK4OX.js';
import {
  MAT_FORM_FIELD,
  MatError,
  MatFormField,
  ...
  MatPrefix,
  MatSuffix,
} from './chunk-YHHXJKFR.js';
import './chunk-2D23S55O.js';
import { AutofillMonitor, TextFieldModule } from './chunk-D2PQB2F5.js';
import { FormGroupDirective, NgControl, NgForm, Validators } from './chunk-HF7RJGO4.js';
import { _ErrorStateTracker } from './chunk-SH5DNOET.js';
import { ErrorStateMatcher } from './chunk-FHHK4PYM.js';
import { _IdGenerator, getSupportedInputTypes } from './chunk-HV5MQX3I.js';
...
import { Subject } from './chunk-U7EDC2PH.js';
...
var MatInput = class _MatInput {
  ...
  _neverEmptyInputTypes = ['date', 'datetime', 'datetime-local', 'month', 'time', 'week'].filter(
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    hostBindings: function MatInput_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵdomProperty('id', ctx.id)('disabled', ctx.disabled && !ctx.disabledInteractive)(
          'required',
          ctx.required,
        );
        ...
        )('mdc-text-field__input', ctx._isInFormField)(
